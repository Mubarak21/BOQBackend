...
export declare class ProjectsService {
    ...
    getProjectResponse(project: Project, userId?: string): Promise<any>;
    ...
    getProjectBoqs(projectId: string, userId: string): Promise<{
        id: string;
        type: BOQType;
        status: BOQStatus;
        fileName: string;

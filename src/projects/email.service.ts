...
export class EmailService {
  ...
  /**
   * Sends a notification when a collaborator is added to a project (e.g. by consultant).
   * Includes invitee name and optional company name in the email.
   */
  async sendCollaboratorAddedNotification(
    toEmail: string,
    inviterName: string,
    projectName: string,
    ...
    try {
      ...
      // Log but do not throw; adding collaborator already succeeded
    }
  }
}
